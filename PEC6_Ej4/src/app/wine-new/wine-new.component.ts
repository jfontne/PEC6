...
createWine() {
  ...
  let Nwine:Wine = {id: 0,name: valors.name,imageUrl: valors.imageURL, price: valors.price, isOnSale: valors.isOnSale, quantityInCart: 1, total: valors.price, foodPairing: []}
  console.log(Nwine);
